...
export default class AvatarForm extends React.Component<Props> {
      ...
      <Form>
        ...
        <FormGroup className='row'>
          <Col
            ...
            <a href='http://eepurl.com/c_7fN9' target='_blank' rel="noreferrer">
  ...
  private onAvatarStyleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (this.props.onAvatarStyleChange) {
      this.props.onAvatarStyleChange((event.target as any).value)
    }
  }

  private onDownloadPNG = (event: React.MouseEvent<HTMLElement>) => {
  ...
  private onDownloadSVG = (event: React.MouseEvent<HTMLElement>) => {
    event.preventDefault()
  ...
  private onToggleCode = (event: React.MouseEvent<HTMLElement>) => {
    event.preventDefault()
  ...
  private onToggleImg = (event: React.MouseEvent<HTMLElement>) => {
    event.preventDefault()
